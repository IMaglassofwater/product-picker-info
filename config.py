...
DAILY_SOURCE_BUDGET_SECONDS = _positive_int("DAILY_SOURCE_BUDGET_SECONDS", 120)
DAILY_EVIDENCE_FRESHNESS_DAYS = _positive_int("DAILY_EVIDENCE_FRESHNESS_DAYS", 7)
DAILY_FALLBACK_ENABLED = os.getenv("DAILY_FALLBACK_ENABLED", "false").casefold() == "true"
